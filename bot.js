...
client.user.setGame(`ZeroShopBc")
...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "help")) {
        let help = new Discord.RichEmbed()
            ...
            برودكاست عادي : Z{prefix}bc
            دعوة البوت لسيرفرك : Z{prefix}invite
            معلومات عن السيرفر : Z{prefix}server
            برودكاست للأونلاين فقط : Z{prefix}bco
            يعرض لك عدد المتبندين من سيرفرك : Z{prefix}banned
            رابط سيرفر الدعم الفني : https://discord.gg/tTvfQq
            **`);
